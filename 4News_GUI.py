...
class NewsApp:
    def __init__(self):
        self.data = requests.get(
            "https://newsapi.org/v2/top-headlines?country=in&apiKey=d05563598bc243bcb34dcc5073b8c59f"
        ).json()
        self.load_gui()
    ...
    # Clear Any Existing Content In The Tkinter Window
    def clear(self):
    ...
    def load_news_item(self, index):
        ...
        try:
            ...
            img_url = "https://upload.wikimedia.org/wikipedia/commons/7/75/No_image_available.png"
            raw_data = urlopen(img_url).read()
            img = Image.open(io.BytesIO(raw_data)).resize((350, 250))
            photo = ImageTk.PhotoImage(img)
